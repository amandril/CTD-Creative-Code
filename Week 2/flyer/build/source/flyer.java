...
public class flyer extends PApplet {
...
public void makeSquareDiag(int x, int y, int size, int number) {
...
public boolean overShaker(int x, int y, int width, int height) {
...
// }
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "flyer" };
    if (passedArgs != null) {
